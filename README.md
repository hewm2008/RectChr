...
**RectChr** 是一款聚焦于染色体（Chr）水平的多层次可视化工具，提供**图形界面**（GUI）和**命令行**（CLI）两种使用方式。

**图形界面**支持实时预览、参数可视化配置、14 种绘图类型一键切换，并可导出 SVG / PDF 格式，适合快速探索和交互式绘图。**命令行模式**则适合批量处理和自动化流程，使用方式与经典的 <b>[circos](http://circos.ca/)</b> 工具类似，但将圈圈图转化为长方形布局，支持横放与纵排。
...
The **GUI** supports real-time preview, visual parameter configuration, 14 plot types with one-click switching, and SVG/PDF export — ideal for rapid exploration and interactive plotting. The **CLI** is suited for batch processing and automation, with a workflow similar to the classic <b>[circos](http://circos.ca/)</b> tool but using rectangular layouts instead of circles, supporting both horizontal and vertical orientations.
...
详细使用说明请参阅：
- [中文 GUI 手册](gui/doc/RectChr_GUI_manual_Chinese.pdf)
- [English GUI Manual](gui/doc/RectChr_GUI_manual_English.pdf)
...
<b> 2.1 下载 Download</b>
</br> Linux / macOS / Windows: [Download v1.50](https://github.com/hewm2008/RectChr/archive/v1.50.tar.gz)
</br> Windows 用户可直接使用图形界面（GUI），需安装 [Perl](https://strawberryperl.com/)和[Python3](https://www.python.org/)。

  </br> <b>2.2 预依赖 Pre-install</b>
  </br> 命令行模式需要以下依赖：
  ...
  </br> 图形界面需要 [Python 3](https://www.python.org/) + [PySide6](https://pypi.org/project/PySide6/)（命令行自动安装依赖）
...
3) Diverse drawing methods: 14 drawing types (plot_type are available), including scatter/point, shape, line, histogram, heatmap, highlights, text, ridgeline, PairWiseLink, LinkS, heatmapAnimated, histAnimated, highlightsAnimated to meet different visualization needs.
...
For a list and description of all parameters, see the file [doc/NewParaList.xlsx](https://github.com/hewm2008/RectChr/blob/main/doc/NewParaList.xlsx). Below is a diagram of the parameters and controls.
![para.png](https://github.com/hewm2008/RectChr/blob/main/doc/para.png)

</br>See the example directory and  Manual.pdf for more detail.

</br>See more detailed usage in the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>[Chinese GUI Documentation](https://github.com/hewm2008/RectChr/blob/main/gui/doc/RectChr_GUI_manual_Chinese.pdf)</b>
</br>See more detailed usage in the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>[English GUI Documentation](https://github.com/hewm2008/RectChr/blob/main/gui/doc/RectChr_GUI_manual_English.pdf)</b>
</br>See more detailed usage in the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>[Chinese Documentation](https://github.com/hewm2008/RectChr/blob/main/doc/RectChr_manual_Chinese.pdf)</b>
</br>See more detailed usage in the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>[English Documentation](https://github.com/hewm2008/RectChr/blob/main/doc/RectChr_manual_English.pdf)</b>
...
![PlotType.png](https://github.com/hewm2008/RectChr/blob/main/doc/PlotType.png)
...
[ZoomRegion1](https://github.com/hewm2008/RectChr/blob/main/Scene_Usage/example09_ZoomRegion)
![out.png](https://github.com/hewm2008/RectChr/blob/main/Scene_Usage/example09_ZoomRegion/OUT1.png)
[ZoomRegion2](https://github.com/hewm2008/RectChr/blob/main/Scene_Usage/example10_Peaks)
![out1.png](https://github.com/hewm2008/RectChr/blob/main/Scene_Usage/example10_Peaks/OUT1.png)
...
![RealCite.png](https://github.com/hewm2008/RectChr/blob/main/doc/RealCite.png)
